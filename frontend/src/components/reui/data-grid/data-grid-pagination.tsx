...
function DataGridPagination(props: DataGridPaginationProps): JSX.Element {
  ...
  // em, not rem, so pagination text scales with the app's S/M/L text-size setting (see data-grid-table.tsx's own note).
  const btnBaseClasses = "p-0 text-[0.85em]"
    ...
    >
      <div className="order-2 flex flex-wrap items-center space-x-2.5 pb-2.5 sm:order-1 sm:pb-0">
        {isLoading ? (
          ...
          <>
            <div className="text-muted-foreground text-[0.85em]">
            ...
            >
              <SelectTrigger className="w-16 text-[0.85em]" size="sm">
                <SelectValue />
              </SelectTrigger>
              <SelectContent
                position="popper"
      ...
      <div className="order-1 flex flex-col items-center justify-center gap-2.5 pt-2.5 sm:order-2 sm:flex-row sm:justify-end sm:pt-0">
        {isLoading ? (
          ...
          <>
            <div className="text-muted-foreground order-2 text-[0.85em] text-nowrap sm:order-1">
              {paginationInfo}
            </div>
            {pageCount > 1 && (
