...
/** Leaf control types (specs/control_attributes.md) -- layout/tab/datatable-column/chart-column/pivot-column/kpi-column are structural, not rendered through this registry. */
